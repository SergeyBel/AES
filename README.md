...
std::vector<unsigned char> plain2 = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff }; // vector instead of c-array
...
// original class constructor, may throw runtime error

Aes<128> aes2;
// templated class constructor, throws compile error instead

unsigned char* c = aes.EncryptECB(plain, plainLen, key, outLen);
//now variable c contains outLen bytes - ciphertext

std::vector<unsigned char> c2 = aes2.EncryptECB(plain, key); // plainLen and outLen are not necessary
...
```
